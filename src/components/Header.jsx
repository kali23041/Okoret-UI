    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-neutral-950/60">
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-2">
          ...
          <a href="/components" className="inline-flex items-center rounded-full border border-neutral-800 bg-neutral-900/40 px-3 py-1 text-[11px] text-neutral-300 hover:bg-neutral-800/60">Components</a>
